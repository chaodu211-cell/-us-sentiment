...
| 红点口径 | 天数/段数 | +21日 | +63日 | 为负 | 2017–2021 | 2022–2026 |
|---|---|---|---|---|---|---|
| 综合温度 > 80（最初） | 56天/18段 | +0.42% | +3.18% | 34% | — | — |
| 减仓温度，杠杆＝多空比 | 81天/26段 | −4.06% | −1.79% | 59% | −5.40% | **+2.49%** |
| 减仓温度，杠杆＝杠杆温度 | 64天/17段 | **−6.03%** | **−2.67%** | **67%** | −4.63% | **−0.31%** |

分年分布也更合理：现口径 2018年3天、2020年19天、2021年13天、2024年15天、2026年14天，
2023 与 2025 零天（对照最初口径：2021泡沫顶 0 天、2023熊市后 21 天，全样本最多）。

**必读的折扣**：减仓侧的边际在样本后半段仍然衰减，只是没原来那么难看——2017–2021 是 −4.63%
（该段基准 +5.70%）、77%为负；2022–2026 是 −0.31%（基准 +4.68%）、55%为负。优势从 10.3 个百分点
缩到 5.0 个（换杠杆口径之前是 11.1 → 2.2）。方向仍然一致，但**别按全样本数字设仓位**。
...
```
杠杆温度 = 杠杆ETF多空比分位 × 1 + 杠杆ETF交易强度分位 × 1      （252日滚动分位，等权）
...
而 2021-11-19 泡沫顶两项都在 96 以上。合成后的秩相关是 **−0.255 / −0.144**，两段同号。
